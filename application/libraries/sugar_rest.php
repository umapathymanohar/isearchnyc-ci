...
class Sugar_REST {
	...
	*/
	//private $rest_url = "10.0.100.30/service/v4_1/rest.php";
	//private $rest_url = "54.72.23.35/sugarcrm/service/v4_1/rest.php";
	//private $rest_url = "localhost/sugarcrm/service/v4_1/rest.php";
        private $rest_url = CRM_URL;
	/**
	* Variable:	$username
	...
	*		to make REST calls.
	*/
	private $username = CRM_USERNAME;
	
	/**
	* Variable:	$password
	* Description:	The password for the $username SugarCRM account
	*/
	private $password = CRM_PASSWORD;
